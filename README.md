...
1.  **Clona el proyecto:**
    ```bash
    git clone https://github.com/SantiBrusa/SistemaDeControlDeStock.git
    ```
...
**Santino Vissani Brusadin** - [@SantiBrusa](https://www.google.com/search?q=https://github.com/SantiBrusa)
